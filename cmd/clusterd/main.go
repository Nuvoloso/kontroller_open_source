...
import (
	...
	app "github.com/Nuvoloso/kontroller/pkg/clusterd"
	csi "github.com/Nuvoloso/kontroller/pkg/clusterd/csi"
	_ "github.com/Nuvoloso/kontroller/pkg/clusterd/handlers"
	_ "github.com/Nuvoloso/kontroller/pkg/clusterd/heartbeat"
	_ "github.com/Nuvoloso/kontroller/pkg/clusterd/snapper"
	_ "github.com/Nuvoloso/kontroller/pkg/clusterd/unbinder"
	appVReq "github.com/Nuvoloso/kontroller/pkg/clusterd/vreq"
...
func main() {
	...
	parser.LongDescription = "The cluster Nuvoloso management service.\n\n" +
	...
	mCtx.AppCtx, err = app.AppInit(&mCtx.AppArgs)
	if err != nil {
		mCtx.Log.Fatal(err)
	}
	...
	if err := mCtx.AppCtx.Start(); err != nil {
		mCtx.Log.Fatal(err)
	}
